      ...
      {status === "idle" || status === "failed" ? (
        <>
          ...
          <div style={{ marginBottom: 16 }}>
            ...
            <p style={{ fontSize: 11, color: "#9AA6A3", margin: "0 0 6px" }}>ضروري لمقارنة حقيقية — بلا هذا سيُقرأ نص عام غير مرتبط بتسجيلك، فتكون كل مقارنات المدة والسرعة والوقفات لاحقًا بلا معنى حقيقي.</p>
