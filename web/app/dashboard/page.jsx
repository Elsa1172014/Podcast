    ...
    <div style={{ maxWidth: 980, margin: "0 auto", padding: 24 }}>
      ...
      {projects.length === 0 ? (
        ...
        <div style={{ display: "grid", gap: 12 }}>
          {projects.map((p) => (
            <div key={p.id} onClick={() => router.push(`/project/${p.id}/script`)} style={{ padding: 16, background: "#fff", borderRadius: 10, border: "1px solid #DCE4DF", cursor: "pointer", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
              <div>
