        ...
        <div style={{ marginBottom: 24, padding: 16, background: "#fff", borderRadius: 12, border: "1px solid #DCE4DF" }}>
          ...
          <div style={{ display: "grid", gap: 8, maxHeight: 200, overflowY: "auto" }}>
            {existingLibrary.map((v) => (
              <div key={v.id} style={{ display: "flex", justifyContent: "space-between", padding: "8px 12px", background: "#F9FAF9", borderRadius: 8, fontSize: 13 }}>
...
function TuneCircles({ settings, onChange, orig, gen }) {
  ...
  return (
    <div>
      ...
      <p style={{ fontSize: 11, color: "#9AA6A3", marginBottom: 14 }}>الدوائر بلا حلقة خضراء مرجعية (التشابه، التعبير، السرعة) لا تملك قيمة أصلية قابلة للقياس المباشر على نفس المقياس — تبقى قابلة للضبط اليدوي دون مقارنة تلقائية.</p>
